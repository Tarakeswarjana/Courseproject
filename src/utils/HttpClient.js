...
const BASE_URL = "https://api.mylearnr.app/api/v1/teacher/";
...
//   // let bash_url = 'https://api.vintagebazaar.in/api/';
//   // let bash_url = "https://127.0.0.1:3030/api/";
//   let bash_url = "https://128.199.25.86:5008/v1/user/";
//   let apiUrl = bash_url + url;
//   console.log("Url " + method, apiUrl);
//   const myHeaders = new Headers();
//   myHeaders.append("Content-Type", "application/json");
//   // myHeaders.append("Access-Control-Allow-Origin", "https://127.0.0.1:3030");
//   myHeaders.append("Access-Control-Allow-Origin", "https://128.199.25.86:5008");
//   if (token != "") {
...
async function fileUplodeDynamic(
  ...
  let bash_url = "https://api.mylearnr.app";
  let apiUrl = bash_url + url;
...
async function fileUplode(
  ...
  let bash_url = "https://api.mylearnr.app/api/v1/teacher/";
  let apiUrl = bash_url + url;
  // let data = new FormData();
  // data.append("image", file);
  // Object.keys(object_get).forEach(function (key) {
  ...
  let headers = {
    // 'Accept': 'application/json',
    // "Content-Type": "multipart/form-data",
    // "Access-Control-Allow-Origin": "https://128.199.25.86:5008",
    authorization: toooo,
    userType: "Teacher",
    // 'Authorization': 'Bearer ' + login_status,
  };
...
async function uploadFileRequestForImage(url, file, callback) {
  // const BASE_URL = Bas;
  // var cancelToken = Axios.CancelToken;
  // var source = cancelToken.source();
  let apiUrl = BASE_URL + url;
