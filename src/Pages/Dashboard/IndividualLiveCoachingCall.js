...
export default function IndividualLiveCoachingCall() {
                    ...
                    <div className="table-wrap">
                        <div className="table-text">
                            <p className="table-header">
                                Recent Individual Live Coaching
                            </p>
                            <p className="table-msg" onClick={()=>navigate("/requests")} style={{cursor:"pointer"}}> New Requests</p> 
                        </div>
                    </div>
                    <div className="table-wrap">
                        <select>
