            ...
            <div className="_enrollment" style={{marginLeft: 0}}>
                      ...
                      <div className="col-md-5 col-12">
                        <div className="__quiz_info">
                          <h4 className="text-white font-weight-bold ">
                            Want to add quiz for your course ?
                          </h4>
                          <p
                            style={{
                          ...
                          <button
                            ...
                            onClick={() => navigate("/add_course/add-quiz")}
                          >
                            Add quiz
                          </button>
                        </div>
              ...
              <div className="row">
                <div className="col-md-12 col-lg-12 col-12">
                  {allQuiz.map((item) => {
                    return (
                      <div className="skill-wrap" key={item._id}>
                        <div className="skill-txt">
                          <p>{item.quizName}</p>
                        </div>
                        <div className="skill-edit">
                          <button>
                            <img src={edit2} alt="edit button" onClick={()=>navigate("add-quiz/"+item._id)} />
                          </button>
                        </div>
                      </div>
                    );
